...
import logoClient from "./../../assets/logo.png";
  ...
  return (
    <div className={header.header}>
      <div className={header.logo}>
        <NavLink to="/">
          <img src={logoClient} width="65" height="57" alt="" />
        </NavLink>
      </div>
      <form action="" className={header.form_search}>
        <div className={header.button_seach}>
        ...
        <input type="text" name="" id="" className={header.form_input} />
      </form>
      <div className={header.infomation}>
        <div className={header.item}>
          <div className={header.icon_phone}></div>
        ...
        <div className={header.item}>
          <div className={header.location_icon}>
            <svg
              width="18"
              height="23.52"
        ...
        <div className={header.item}>
          <div className={header.bill_icon}>
            <UserOutlined />
          </div>
          {auth ? (
            <Dropdown overlay={menuAuth} placement="bottomRight" arrow>
              <p className={header.btn_auth}>
                Hi! <br />
                {auth?.user?.name}
              </p>
            </Dropdown>
